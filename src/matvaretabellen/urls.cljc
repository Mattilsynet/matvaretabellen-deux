...
(defn get-food-groups-api-url [locale format]
  (str "/api/" (name locale) "/food-groups." (name format)))

(defn get-nutrients-api-url [locale format]
  (str "/api/" (name locale) "/nutrients." (name format)))
