...
(defn render-page [context page]
  (let [db (:foods/db context)]
    (case (:page/kind page)
      ...
      :page.kind/food-group-excel (excel/render-food-group-foods context (get-latest-year) page)
      ...
      :page.kind/foods-excel (excel/render-all-foods context (get-latest-year) page)
      :page.kind/langual-data (api/render-langual-data context page)
      :page.kind/nutrient-data (api/render-nutrient-data context page)
      :page.kind/nutrient-excel (excel/render-nutrient-foods context (get-latest-year) page)
